...
const mockProfile = {
  employee: {
    ...
    emergencyContact: "98765 12345",
    skills: ["React", "Node.js", "Python", "AWS"],
    documents: [
      { name: "Aadhar Card", status: "verified", uploadedAt: "2023-03-15" },
      { name: "PAN Card", status: "verified", uploadedAt: "2023-03-15" },
      { name: "Educational Certificates", status: "verified", uploadedAt: "2023-03-16" },
      { name: "Experience Letter", status: "pending", uploadedAt: "2023-03-16" },
    ]
  },
  hr_manager: {
    id: "HRM001",
    ...
    joinDate: "2020-01-10",
    location: "Bangalore, India",
    address: "456 HR Block, Electronic City, Bangalore - 560100",
    dob: "1988-11-15",
    bloodGroup: "A+",
    emergencyPhoneCode: "+91",
    emergencyContact: "98765 00001",
    skills: ["HR Management", "Recruitment", "Employee Relations", "HRIS"],
    documents: [
      { name: "Aadhar Card", status: "verified", uploadedAt: "2020-01-10" },
      { name: "PAN Card", status: "verified", uploadedAt: "2020-01-10" },
      { name: "Educational Certificates", status: "verified", uploadedAt: "2020-01-11" },
    ]
  }
};
...
export default function Profile() {
  ...
  const profile = user.role === "hr_manager" ? mockProfile.hr_manager : mockProfile.employee;
  ...
  const [editData, setEditData] = useState({
    ...
    emergencyPhoneCode: profile.emergencyPhoneCode,
        ...
        <div className="p-6 animate-fade-in-up stagger-1" style={cardStyle}>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between py-2" style={{ borderBottom: `1px solid ${isDark ? '#334155' : '#e2e8f0'}` }}>
              ...
              <span className="font-medium" style={{ color: textPrimary }}>{profile.email}</span>
            </div>
            <div className="flex items-center justify-between py-2" style={{ borderBottom: `1px solid ${isDark ? '#334155' : '#e2e8f0'}` }}>
              ...
              {isEditing ? (
                ...
                <span className="font-medium" style={{ color: textPrimary }}>{profile.phoneCode} {profile.phone}</span>
              )}
            </div>
            <div className="flex items-center justify-between py-2" style={{ borderBottom: `1px solid ${isDark ? '#334155' : '#e2e8f0'}` }}>
              <span style={{ color: textSecondary }}>Date of Birth</span>
              <span className="font-medium" style={{ color: textPrimary }}>{new Date(profile.dob).toLocaleDateString()}</span>
            </div>
            <div className="flex items-center justify-between py-2" style={{ borderBottom: `1px solid ${isDark ? '#334155' : '#e2e8f0'}` }}>
              ...
              <div className="px-6 py-5" style={{ backgroundColor: '#f5f5f5' }}>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-semibold" style={{ color: '#1a1a1a' }}>{new Date(profile.joinDate).toLocaleDateString()}</p>
                  </div>
                  <div>
              ...
              <div className="px-6 py-4" style={{ backgroundColor: '#ffffff', borderTop: '1px solid #e5e5e5' }}>
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-medium" style={{ color: '#1a1a1a' }}>{profile.email}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ backgroundColor: '#f5f5f5' }}>📱</span>
                    <span className="text-sm font-medium" style={{ color: '#1a1a1a' }}>{profile.phoneCode} {profile.phone}</span>
                  </div>
                </div>
              </div>
